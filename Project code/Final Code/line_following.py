...
DEBUG = False
def debug_print(*args):   #debug printing function for testing - ensuring print statements could be easily turned off when rover not attached to laptop to prevent performance issues
    if DEBUG:
        print(*args)
